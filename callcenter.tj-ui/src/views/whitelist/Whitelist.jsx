...
const EMPTY = { phone: '', comment: '', active: true }
...
export default function Whitelist() {
  ...
  const openEdit   = (e) => {
    setEditing(e)
    setForm({ phone: e.phone, comment: e.comment, active: e.active })
    setModal(true)
  }
            ...
            <CTable hover responsive>
              <CTableHead>
                <CTableRow>
                  ...
                  <CTableHeaderCell>{t('whitelist.col_comment')}</CTableHeaderCell>
      ...
      <CModal visible={modal} onClose={() => setModal(false)}>
        ...
        <CModalBody>
          <CForm className="d-flex flex-column gap-3">
            ...
            <div>
              <CFormLabel>{t('whitelist.comment_label')}</CFormLabel>
              <CFormInput
                value={form.comment}
                onChange={e => setForm(f => ({ ...f, comment: e.target.value }))}
                placeholder={t('whitelist.comment_placeholder')}
              />
            </div>
            <CFormCheck
